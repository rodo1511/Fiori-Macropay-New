		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Guias Cotizador",
									"targetURL": "#guiascotizadorguiascotizador-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"guiascotizadorguiascotizador-display": {
								"semanticObject": "guiascotizadorguiascotizador",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=guiascotizador.guiascotizador",
									"url": sap.ui.require.toUrl("guiascotizador/guiascotizador")
								}
							}
						}
					}
